# R01_B generator defect: missing dependency sheets - CR-DB-0121
...
## Defect
R01_B currently lacks DB-generated dependency sheets required by F.D.KUM.01 formulas.

## Missing dependency sheets
...
## Required fix
Extend DB/rules/generator so these sheets are emitted as part of R01_B or as governed dependency outputs inside the same workbook.

## Non-solution
Do not solve by manual copy from main.xlsx. Do not rely on output-level formula patching as final architecture.
